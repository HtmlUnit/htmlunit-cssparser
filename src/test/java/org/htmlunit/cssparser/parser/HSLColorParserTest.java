...
public class HSLColorParserTest extends AbstractCSSParserTest {
    ...
    public void hslRelative() throws Exception {
        color("foreground: hsl(from red r g b)", "foreground: hsl(from red r g b)");
        ...
        // color("foreground: hsl(from var(--base-color) 7 11% 13%)", "foreground: red calc(h + 7) calc(s - 11%) calc(l * 13%)");
    }
